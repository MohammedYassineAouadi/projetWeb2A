...
<body>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="./front/offre_emploi/offre_emploi.php">Offres
                                    d'Emploi</a></li>
                            ...
                            <?php if (!isset($_SESSION['user'])): ?>
                                <li class="main-button"><a href="./frontoffice/Vue/connexion.php">Sign In</a></li>
                            <?php else: ?>
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                                        ...
                                        <a class="dropdown-item" href="./frontoffice/Vue/mon_profil.php"><i
                                                    class="fa fa-user" style="margin-right: 5px;"></i>Mon Profil</a>
                                        <?php if ($_SESSION['user']['role'] === 'admin'): ?>
                                            <a class="dropdown-item" href="./backoffice/Vue/dashboard.php"><i
                                                    class="fa fa-tachometer" style="margin-right: 5px;"></i>Dashboard</a>
                                        <?php endif; ?>
                                        <a class="dropdown-item" href="./frontoffice/logout.php"><i
    ...
    <div class="main-banner" id="top">
        <video autoplay muted loop id="bg-video">
            <source src="./assets/front/images/gym.mp4" type="video/mp4" />
        </video>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        ...
                        <img src="./assets/front/images/line-dec.png" alt="waves">
                        <!-- <p>Training Studio is free CSS template for gyms and fitness centers. You are allowed to use this layout for your business website.</p>-->
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="left-image">
                        <img src="./assets/front/images/image.png" alt="">
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
                    <div class="content-section">
                        ...
                        <br><br>
                        <p>
                            Our platform seamlessly combines online learning with recruitment opportunities. As an
                            educational hub, it offers a range of features such as video courses, quizzes, and forums to
                            enhance the learning experience. At the same time, it provides companies with the ability to
                            post job listings and content to attract entrepreneurs and talent. With personalized
                            profiles, secure payment options, and AI-driven recommendations, our platform delivers a
                            comprehensive experience for learning, networking, and discovering professional
                            opportunities.
                        </p>
                    </div>
