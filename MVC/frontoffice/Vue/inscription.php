...
<body>
    ...
    <div class="form-container">
        ...
        <form id="registerForm" action="../Controleur/auth.php?action=register" method="POST">
...
"></div>
        ...
        <div class="social-login-wrapper">
            <a href="../Controleur/google_signup.php" class="social-btn google-btn">
            ...
            <a href="../Controleur/github_signup.php" class="social-btn github-btn">
