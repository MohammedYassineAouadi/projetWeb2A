...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($_SESSION['code_verified']) || !$_SESSION['code_verified'] || !isset($_SESSION['reset_email'])) {
        header('Location: ../Vue/verify_code.php?error=notverified');
        exit;
    }
    ...
    if (!$user) {
        ...
        header('Location: ../Vue/reset_password.php?error=invalidemail');
        exit;
    }
    ...
    header('Location: ../Vue/connexion.php?success=passwordreset');
    exit;
}
?>
