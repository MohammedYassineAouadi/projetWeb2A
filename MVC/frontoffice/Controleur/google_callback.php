...
if (!isset($_GET['code'])) {
    header('Location: ../Vue/connexion.php?error=google_msg&msg=missing_code');
    exit;
}
...
if (!isset($token_data['access_token'])) {
    header('Location: ../Vue/connexion.php?error=google_msg&msg=token_error');
    exit;
}
...
if (isset($userinfo['email'])) {
    ...
    if ($utilisateur) {
        ...
        header('Location: ../Vue/connexion.php?error=google_msg&msg=user_not_found');
        exit;
    }
} else {
    header('Location: ../Vue/connexion.php?error=google_msg&msg=userinfo_error');
    exit;
}
