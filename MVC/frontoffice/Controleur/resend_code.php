...
if (!$email) {
    header('Location: ../Vue/motdepasse_oublie.php?error=emailnotfound');
    exit;
}
...
try {
    ...
    $mail->send();
    header('Location: ../Vue/verify_code.php?resent=success');
    exit;

} catch (Exception $e) {
    error_log("Erreur mail : " . $mail->ErrorInfo);
    header('Location: ../Vue/verify_code.php?resent=error');
    exit;
}
