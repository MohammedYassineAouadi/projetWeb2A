...
if (!isset($_GET['code'])) {
    header('Location: ../Vue/inscription.php?error=google_signup_msg&msg=missing_code');
    exit;
}
...
if (!isset($token_data['access_token'])) {
    header('Location: ../Vue/inscription.php?error=google_signup_msg&msg=token_error');
    exit;
}
...
if (isset($userinfo['email'])) {
    ...
    if ($utilisateur) {
        header('Location: ../Vue/inscription.php?error=google_signup_msg&msg=exists');
        exit;
    }
    ...
    header('Location: ../Vue/inscription.php?error=google_signup_msg&msg=userinfo_error');
    exit;
}
