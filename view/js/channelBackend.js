            ...
            data.forEach(function(channel) {
                tableContent += `
                    <tr data-id="${channel.id}">
                        <td>${channel.id}</td>
                        <td><img src="${channel.image_url || 'img/default-channel.png'}" alt="${channel.name}" class="channel-image"></td>
...
function openEditModal(channelId) {
    $.ajax({
        url: '../controler/getchannels.php?id=' + channelId, // FIXED
        type: 'GET',
        dataType: 'json',
