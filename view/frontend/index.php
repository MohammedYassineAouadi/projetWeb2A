...
// Crée une instance de ReclamationController pour accéder aux méthodes
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['delete'])) {
        ...
        header('Location: ../frontend/index.php?success=delete');
        exit();
    }
        ...
        <?php foreach ($reclamations as $row): ?>
            <div class="announcement-card">
                ...
                <form method="POST" action="index.php">
                    ...
                    <input type="text" name="update_contenu" value="<?= htmlspecialchars($row['contenu']) ?>" required>
                    <input type="text" name="update_type" value="<?= htmlspecialchars($row['type']) ?>" required>
                    <select name="update_statut" required>
