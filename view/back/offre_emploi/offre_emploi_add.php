<?php /* DeskApp/Bootstrap styled Add Offer Form */ ?>
<!DOCTYPE html>
<html lang="fr">
        ...
        <div class="menu-block customscroll">
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    <li><a href="offre_emploi_list.php" class="dropdown-toggle no-arrow"><span class="micon dw dw-list"></span><span class="mtext">Liste des Offres</span></a></li>
                    <li><a href="../candidature/candidature_list.php" class="dropdown-toggle no-arrow"><span class="micon dw dw-user1"></span><span class="mtext">Liste des Candidatures</span></a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="min-height-200px">
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix mb-20">
                        <div class="pull-left">
                            <h4 class="text-blue h4">Ajouter une Offre d'Emploi</h4>
                        </div>
                    </div>
                    <?php if (isset($_GET['success']) && $_GET['success'] == 1): ?>
                        <div class="alert alert-success">Offre d'emploi ajoutée avec succès!</div>
                    <?php endif; ?>
                    <form method="post" action="offre_emploi_add_action.php" id="offreAddForm" novalidate>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" name="entreprise" id="entreprise" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="number" name="salaire" id="salaire" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control date-picker" type="date" name="date_limit" id="date_limit"
                                    required>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 col-md-10 offset-md-2">
                                <button class="btn btn-primary" type="submit"
                                    onclick="return validform();">Ajouter</button>
                                <a href="offre_emploi_list.php" class="btn btn-secondary">Retour à la liste</a>
                            </div>
                        </div>
                    </form>
                    <script src="offre_emploi_add_validator.js"></script>
                </div>
            </div>
        </div>
    </div>
